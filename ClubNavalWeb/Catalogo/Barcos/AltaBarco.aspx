    ...
    <div class="container">
        ...
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="rfvTxtMatricula" ValidationGroup="Guardar" runat="server" CssClass="text-danger" 
                    ControlToValidate="txtMatricula" ErrorMessage="Matricula del barco requerida"></asp:RequiredFieldValidator>
            </div>
            <div style="position:absolute;top:0;left:0;">
        ...
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="rfvTxtNoAmarre" 
                    ...
                    ControlToValidate="txtNoAmarre" ErrorMessage="El numero de amarre es necesario"></asp:RequiredFieldValidator>
            </div>
            <div style="position:absolute;top:0;left:0;">
                <asp:RegularExpressionValidator ID="revTxtNoAmarre" runat="server" CssClass="text-danger" 
                    ...
                    ErrorMessage="El formato de numero de amarre es 000XX"></asp:RegularExpressionValidator>
            </div>
        </div>
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="rfvTxtNombre" 
                    ValidationGroup="Guardar" runat="server" CssClass="text-danger" 
                    ControlToValidate="txtNombre" ErrorMessage="Nombre del barco requerido"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="rfvTxtCuota" 
                    ValidationGroup="Guardar" runat="server" CssClass="text-danger" 
                    ControlToValidate="txtCuota" ErrorMessage="Cuota requerida"></asp:RequiredFieldValidator>
            </div>
            <div style="position:absolute;top:0;left:0;">
        ...
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="RrfvDdlOwner" 
                    ValidationGroup="Guardar" runat="server" CssClass="text-danger" 
                    ControlToValidate="ddlOwner" InitialValue="0" ErrorMessage="Selecciona el dueño del barco"></asp:RequiredFieldValidator>
            </div>
        </div>
        ...
        <div class="row form-group">
            <asp:Button ID="btnGuardar" ValidationGroup="Guardar" runat="server" Text="Guardar" 
                CssClass="btn btn-success" Visible="false" OnClick="btnGuardar_Click"></asp:Button>
        </div>
    </div>
</asp:Content>
